...
public abstract class AbstractAndroidDevice implements IShellOutputReceiver {
	...
	public void pullFileFromDevice(String remoteFilepath, String localFilename) throws Exception {
		try {
			device.getSyncService().pullFile(remoteFilepath, localFilename, SyncService.getNullProgressMonitor());
		} catch (Exception e) {
			logger.error("Exception ", e);
			throw e;
		}
	...
	public int getSdkVersion() throws Exception{
		String version = device.getProperty("ro.build.version.sdk");
